...
#
# This script lives in .kif/skills/rename-starter/scripts/ as a reference.
# The runnable copy is at scripts/rename.sh in the project root.
# If the project-root copy is missing, copy this one there first.
